                  ...
                  <div className="author-hover-box">
                    ...
                    <div className="author-hover-footer">
                      ...
                      <div className="author-hover-socials">
                        {post.author?.twitter && (
                          <a href={post.author.twitter} target="_blank" rel="noopener noreferrer" className="author-hover-icon" aria-label="Twitter">
                        ...
                        {post.author?.linkedin && (
                          <a href={post.author.linkedin} target="_blank" rel="noopener noreferrer" className="author-hover-icon" aria-label="LinkedIn">
                            <svg width="12" height="12" fill="currentColor" viewBox="0 0 16 16">
                        ...
                        {post.author?.website && (
                          <a href={post.author.website} target="_blank" rel="noopener noreferrer" className="author-hover-icon" aria-label="Website">
